...
namespace GoldSprite.MyUdpperAPI
{
    public class PacketCodeC
    {
        ...
        public PacketCodeC()
        {
            ...
            packetTypeMap.Add(ICommand.BROADCAST_REQUEST, typeof(BroadcastRequestPacket));
            packetTypeMap.Add(ICommand.BROADCAST_RESPONSE, typeof(BroadcastResponsePacket));
            packetTypeMap.Add(ICommand.LOGIN_REQUEST, typeof(LoginRequestPacket));
            packetTypeMap.Add(ICommand.LOGIN_RESPONSE, typeof(LoginResponsePacket));
        }
